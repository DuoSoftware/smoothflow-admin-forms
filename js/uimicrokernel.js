(function (mkm) {
    ...
    function getHost() {
        ...
        // used by the addon to identify which user is logged in
        if (window.location.search != "") {
            var paramValue = unescape(window.location.search).slice(1).split(/&/);
            var variableName = "xdm_e";
            var selected = "";
            for (var j = 0; j < paramValue.length; j++) {
                if (paramValue[j].match(variableName)) { selected = paramValue[j]; break; }
            }
    ...
    function getBotHost() {
        return (getHost().indexOf("dev.smoothflow.io") > -1 || getHost().indexOf("localhost") > -1) ? "smoothbotdev" : "smoothbot";
    }
    ...
    mkm.factory('$objectstore', function ($http, $v6urls, $auth, $backdoor) {
        ...
        function ObjectStoreClient(_namespace, _class) {
            ...
            function V1insert(data, parameters) {
                var mainObject = null;
                if (angular.isArray(data)) mainObject = {
                    Parameters: parameters,
                    Objects: data
                ...
                V1send("POST", mainObject, "insert");
            }

            function V1send(mode, params, opMode) {
                if (mode == "GET") {
                    //"securityToken": $auth.getSecurityToken()"securityToken": "ignore"
                    $http.get($v6urls.objectStore + '/' + namespace + '/' + cls + getParams, {
                        headers: {
                            "securityToken": "ignore"
                        }
                        ...
                        if (!response.data.success) {
                            ...
                            if (getParams[0] == '?') {
                                if (onGetMany) onGetMany(response.data.result);
                            } else {
                                if (onGetOne) onGetOne(response.data.result);
                            }
                        }
            ...
            return {
                ...
                v1getByFiltering: function (filter, parameters) {
                    V1send("POST", {
                        "Query": {
                            "Type": "Query",
                            "Parameters": filter
                ...
                V1insert: function (data, parameters) {
                    V1insert(data, parameters);
                    return this;
                },
                ...
                V1deleteSingle: function (data, parameters) {
                    this.V1delete(data, {
                        "KeyProperty": parameters
                    });
                    return this;
                ...
                V1deleteMultiple: function (data, parameters) {
                    this.V1delete(data, {
                        "KeyProperty": parameters
                    });
                    return this;
                ...
                V1delete: function (data, parameters) {
                    //Get Absolute ID
                    var mainObject = null;
                    if (angular.isArray(data))
                        mainObject = {
        ...
        return {
            getClient: function (namespace, cls, isGlobal) {
                ...
                //var req = new ObjectStoreClient("binuka.smoothflow.io", cls);
                //var req = new ObjectStoreClient("lakmini.dev.smoothflow.io", cls);
                // var req = new ObjectStoreClient("cookiemonster.dev.smoothflow.io", cls);
                //var req = new ObjectStoreClient("tistuslabs.dev.smoothflow.io", cls);

                // new way
                var session = $auth.getPayload();
                var workspace = session.companyName + "." + $v6urls.BaseDomain;
                var req = new ObjectStoreClient(workspace, cls);
                return req;
            }
        }
    });
    ...
    mkm.factory('$auth', function ($http, $v6urls, $backdoor, $rootScope, $helpers) {
        ...
        function login(username, password, domain) {
            ...
            $http({
                method: 'POST',
                url: "http://" + host + "/apis/authorization/userauthorization/login",
                headers: {
            ...
            execute: function (sc, renderElement, appCode, errorCallback) {
                $v6downloader.download(appCode, function (successData) {
                    ...
                    if (!iFrameUrl)
                        ...
                        engineHtml = "<iframe frameborder='0' style='width:100%;height:100%;border: 0;' src='" + iFrameUrl + "'></iframe>";
    ...
    mkm.factory('$v6urls', function () {
        ...
        var bothost = getBotHost(this);

        var p = location.protocol;
        // if (host.indexOf("localhost") != -1 || host.indexOf("127.0.0.1") != -1)
        //     p = "https:";

        if (location.hostname == "localhost" || location.hostname == "dev.smoothflow.io") {
            // on development env
        return {
            auth: p + "//" + host + "/auth",
            objectStore: p + "//" + host + "/data",
                BaseDomain: "dev.smoothflow.io", // used on the login page | dev.smoothflow.io | smoothflow.io
            FacetoneClientId: "3e68cdd0-1bb0-11e8-a2d3-754f63b10f12", // used on the login page
                fws: p + "//devceb.plus.smoothflow.io", // devceb.plus.smoothflow.io | ceb.plus.smoothflow.io
                processManager: "https://devprocessengine.plus.smoothflow.io", // devprocessengine.plus.smoothflow.io | processengine.plus.smoothflow.io
                smoothflowIP: "https://dev.smoothflow.io", // dev.smoothflow.io | smoothflow.io
                nginxserver: "https://nginxproxymaker.plus.smoothflow.io",
                nginxlog: "https://nginxlogdev.plus.smoothflow.io",
                mediaLib: p + "//" + host + "/apis/media",
                cebproxyservice: p + "//devcebrest.plus.smoothflow.io",// devcebrest.plus.smoothflow.io | cebrest.plus.smoothflow.io
            veery: ".app.facetone.com/DVP/API/1.0.0.0/",
                globalOS: "https://devobj.plus.smoothflow.io/com.duosoftware.com", // devobj.plus.smoothflow.io/com.duosoftware.com | obj.plus.smoothflow.io/com.duosoftware.com
            jiraAPI: p + "//jiraconnector.plus.smoothflow.io",
            plan: "https://payment.plus.smoothflow.io",
            userService: {
                url: "https://userserviceproduction.plus.smoothflow.io", //userserviceproduction
                version: "DVP/API/1.0.0.0",
            },
            walletService: {
                url: "https://walletserviceproduction.plus.smoothflow.io",
                version: "DVP/API/1.0.0.0",
            },
            authGeneratorService: {
                    url: "https://smoothauthgeneratordev.plus.smoothflow.io", // smoothauthgeneratordev.plus.smoothflow.io | smoothauthgenerator.plus.smoothflow.io
                version: "DBF/API/1.0.0.0",
                },
                botFrameworkFacebookConnector: {
                    url: p + "//" + bothost + ".plus.smoothflow.io/fb",
                },
                /*botplatformUrl: {
                    url: p + "//" + bothost + ".plus.smoothflow.io/fb/DBF/API/v1/platform/",
                }*/
            };
        } else if (location.hostname == "smoothflow.io") {
            // on production env
            return {
                auth: p + "//" + host + "/auth",
                objectStore: p + "//" + host + "/data",
                BaseDomain: "smoothflow.io", // used on the login page | dev.smoothflow.io | smoothflow.io
                FacetoneClientId: "3e68cdd0-1bb0-11e8-a2d3-754f63b10f12", // used on the login page
                fws: p + "//ceb.plus.smoothflow.io", // devceb.plus.smoothflow.io | ceb.plus.smoothflow.io
                processManager: "https://processengine.plus.smoothflow.io", // devprocessengine.plus.smoothflow.io | processengine.plus.smoothflow.io
                smoothflowIP: "https://smoothflow.io", // dev.smoothflow.io | smoothflow.io
                nginxserver: "https://nginxproxymaker.plus.smoothflow.io",
                nginxlog: "https://nginxlogproduction.plus.smoothflow.io",
                mediaLib: p + "//" + host + "/apis/media",
                cebproxyservice: p + "//cebrest.plus.smoothflow.io",// devcebrest.plus.smoothflow.io | cebrest.plus.smoothflow.io
                veery: ".app.facetone.com/DVP/API/1.0.0.0/",
                globalOS: "https://obj.plus.smoothflow.io/com.duosoftware.com", // devobj.plus.smoothflow.io/com.duosoftware.com | obj.plus.smoothflow.io/com.duosoftware.com
                jiraAPI: p + "//jiraconnector.plus.smoothflow.io",
                plan: "https://payment.plus.smoothflow.io",
                userService: {
                    url: "https://userserviceproduction.plus.smoothflow.io", //userserviceproduction
                ...
                authGeneratorService: {
                    url: "https://smoothauthgenerator.plus.smoothflow.io", // smoothauthgeneratordev.plus.smoothflow.io | smoothauthgenerator.plus.smoothflow.io
                    version: "DBF/API/1.0.0.0",
                },
                botFrameworkFacebookConnector: {
                    url: p + "//" + bothost + ".plus.smoothflow.io/fb",
    ...
    mkm.directive("duoapp", ["$rootScope", "$compile", "$presence", "$chat", "$webrtc", "$auth", "$backdoor", "$objectstore", "$agent", "$srs", "$uploader", "$apps", "$helpers", "$events", "$interval", "$timeout", "$http", function ($rootScope, $compile, $presence, $chat, $webrtc, $auth, $backdoor, $objectstore, $agent, $srs, $uploader, $apps, $helpers, $events, $interval, $timeout, $http) {
        return {
            restrict: "E",
    ...
    mkm.directive("iduoapp", ["$rootScope", "$compile", "$presence", "$chat", "$webrtc", "$auth", "$backdoor", "$objectstore", "$agent", "$srs", "$uploader", "$apps", "$helpers", "$interval", "$timeout", "$http", function ($rootScope, $compile, $presence, $chat, $webrtc, $auth, $backdoor, $objectstore, $agent, $srs, $uploader, $apps, $helpers, $interval, $timeout, $http) {
        return {
            restrict: "E",
